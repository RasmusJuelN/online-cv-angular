...
export class HomeComponent {
  ...
  projects = [
    ...
    {title: 'React project', link:'https://github.com/TempoTuneCorp/TempoTuneCorp.github.io', description: 'Working on a react project.', skills:['C#', 'ASP.NET', 'API', 'CSS', 'Github'], image: 'https://t3.ftcdn.net/jpg/05/51/89/58/360_F_551895859_ZuQWVnCA7DGMf8PDOLVeNiygUS4AjGc0.jpg'},
